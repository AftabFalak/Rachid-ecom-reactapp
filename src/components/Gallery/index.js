  ...
  return (
    <div className="Gallery">
      ...
      <div className="d-flex justify-content-between productDropDownsView">
        <button className="btn btn-filters" onClick={() => setOpen(true)}><i className="fa fa-filter"></i> Filters</button>
   ...
   {open &&    <FilterDrawer open={open} drawertoggle={toggleOpenDrawer} filters={filters} />}
